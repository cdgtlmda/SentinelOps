...
export function Header() {
  return (
    <header className="absolute top-0 w-full flex items-center justify-between p-4 z-10">
      <span className="hidden md:block text-sm font-medium">SentinelOps</span>
      ...
      <nav className="md:mt-2">
        <ul className="flex items-center gap-4">
          <li>
            <a
              href="https://github.com/sentinelops-ai/sentinelops-ui"
            ...
            <Dialog>
              ...
              <DialogContent>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Subscribe to our newsletter to get the latest SentinelOps news and
                    updates.
                  </DialogDescription>
                </DialogHeader>
